...
add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -regexp .*FHE_ACC_TOP/AXIL_BAR1_SLV/AXIL_BAR1_REG_SLC_2.*]
add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -regexp .*FHE_ACC_TOP/RLWE_INPUT_FIFO.*]
add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -regexp .*FHE_ACC_TOP/RLWE_OUTPUT_FIFO.*]
add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -regexp .*FHE_ACC_TOP/KEY_LOAD.*]
add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -regexp .*FHE_ACC_TOP/COMPUTE_CHAIN.*]
add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -regexp .*FHE_ACC_TOP/CL_DMA_PCIS_SLV/FHE_CORE_DDR_REG_SLC_1.*]
add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -regexp .*FHE_ACC_TOP/CL_DMA_PCIS_SLV/RLWE_INPUT_AXI4_REG_SLC_2.*]
add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -regexp .*FHE_ACC_TOP/CL_DMA_PCIS_SLV/RLWE_OUTPUT_AXI4_REG_SLC_2.*]
#add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/FHE_ACC_TOP/CL_DMA_PCIS_SLV/CL_TST_DDR_A*}]
#add_cells_to_pblock [get_pblocks pblock_CL_top] [get_cells -quiet -hierarchical -filter {NAME =~ WRAPPER_INST/CL/FHE_ACC_TOP/CL_DMA_PCIS_SLV/DDR_A_TST_AXI4_REG_SLC_2*}]
...
resize_pblock [get_pblocks pblock_CL_top] -add {SLICE_X88Y600:SLICE_X168Y899}
resize_pblock [get_pblocks pblock_CL_top] -add {DSP48E2_X11Y240:DSP48E2_X18Y359}
resize_pblock [get_pblocks pblock_CL_top] -add {LAGUNA_X12Y480:LAGUNA_X23Y719}
resize_pblock [get_pblocks pblock_CL_top] -add {RAMB18_X7Y240:RAMB18_X11Y359}
resize_pblock [get_pblocks pblock_CL_top] -add {RAMB36_X7Y120:RAMB36_X11Y179}
resize_pblock [get_pblocks pblock_CL_top] -add {URAM288_X2Y160:URAM288_X3Y239}
...
add_cells_to_pblock [get_pblocks pblock_CL_mid] [get_cells -quiet -hierarchical -regexp .*FHE_ACC_TOP/AXIL_BAR1_SLV/AXIL_BAR1_REG_SLC_1.*]
add_cells_to_pblock [get_pblocks pblock_CL_mid] [get_cells -quiet -hierarchical -regexp .*FHE_ACC_TOP/AXIL_OCL_SLV/AXIL_OCL_REG_SLC_2.*]
add_cells_to_pblock [get_pblocks pblock_CL_mid] [get_cells -quiet -hierarchical -regexp .*FHE_ACC_TOP/CL_DMA_PCIS_SLV/FHE_CORE_DDR_REG_SLC_2.*]
add_cells_to_pblock [get_pblocks pblock_CL_mid] [get_cells -quiet -hierarchical -regexp .*FHE_ACC_TOP/CL_DMA_PCIS_SLV/AXI_CROSSBAR.*]
add_cells_to_pblock [get_pblocks pblock_CL_mid] [get_cells -quiet -hierarchical -regexp .*FHE_ACC_TOP/CL_DMA_PCIS_SLV/DDR_B_TST_AXI4_REG_SLC_1.*]
add_cells_to_pblock [get_pblocks pblock_CL_mid] [get_cells -quiet -hierarchical -regexp .*FHE_ACC_TOP/CL_DMA_PCIS_SLV/DDR_B_TST_AXI4_REG_SLC_2.*]
add_cells_to_pblock [get_pblocks pblock_CL_mid] [get_cells -quiet -hierarchical -regexp .*FHE_ACC_TOP/CL_DMA_PCIS_SLV/RLWE_INPUT_AXI4_REG_SLC_1.*]
add_cells_to_pblock [get_pblocks pblock_CL_mid] [get_cells -quiet -hierarchical -regexp .*FHE_ACC_TOP/CL_DMA_PCIS_SLV/RLWE_OUTPUT_AXI4_REG_SLC_1.*]
...
add_cells_to_pblock [get_pblocks pblock_CL_bot] [get_cells -quiet -hierarchical -regexp .*FHE_ACC_TOP/AXIL_OCL_SLV/AXIL_OCL_REG_SLC_1.*]
