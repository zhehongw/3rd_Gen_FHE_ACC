...
################################################################
# This is a generated script based on design: my_dma_axi_xbar
#
...
# source my_dma_axi_xbar_script.tcl
...
set design_name my_dma_axi_xbar
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {S00_AXI:M00_AXI:M01_AXI:M02_AXI:S01_AXI} \
  ...
  connect_bd_net -net ACLK_1 [get_bd_ports ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK]
  connect_bd_net -net ARESETN_1 [get_bd_ports ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN]
  ...
  assign_bd_address -offset 0x000400000000 -range 0x00008000 -target_address_space [get_bd_addr_spaces S00_AXI] [get_bd_addr_segs M01_AXI/Reg] -force
  assign_bd_address -offset 0x000400000000 -range 0x00008000 -target_address_space [get_bd_addr_spaces S01_AXI] [get_bd_addr_segs M01_AXI/Reg] -force
  assign_bd_address -offset 0x000400008000 -range 0x00008000 -target_address_space [get_bd_addr_spaces S00_AXI] [get_bd_addr_segs M02_AXI/Reg] -force
  assign_bd_address -offset 0x000400008000 -range 0x00008000 -target_address_space [get_bd_addr_spaces S01_AXI] [get_bd_addr_segs M02_AXI/Reg] -force
